<?php /* Smarty version Smarty-3.1.17, created on 2015-05-17 21:05:38
         compiled from "C:\wamp\www\PHP_LeMarane\view\smarty\templates\back\ImageManagement.tpl" */ ?>
<?php /*%%SmartyHeaderCode:273805558e68295fd03-87481373%%*/if(!defined('SMARTY_DIR')) exit('no direct access allowed');
$_valid = $_smarty_tpl->decodeProperties(array (
  ...
  'nocache_hash' => '273805558e68295fd03-87481373',
  'function' => 
  array (
  ),
  'variables' => 
  ...
  'unifunc' => 'content_5558e6833ba810_28134558',
),false); /*/%%SmartyHeaderCode%%*/?>
<?php if ($_valid && !is_callable('content_5558e6833ba810_28134558')) {function content_5558e6833ba810_28134558($_smarty_tpl) {?><?php if (!is_callable('smarty_modifier_truncate')) include 'C:\\wamp\\www\\PHP_LeMarane\\lib\\smarty\\libs\\plugins\\modifier.truncate.php';
?>
<!-- TABELLA IMMAGINI
============================================================================ -->
...
<?php } else { ?>
    ...
    <div class="noContentBack">
        <p>
            <span>Oops...</span>
            In questo momento non sono presenti immagini. <br/>
            Inseriscine una nuova adesso :)
        </p>
        <button id="insertButton" class="handlebarsButton">Inserisci</button>
    </div>
...
<script>
    ...
    MyTablePopover.prototype = {
        ...
        init: function () {
            ...
            if (!this.tableCarousel) {

                // siamo nel caso in cui non ci sono contenuti
                // quindi dobbiamo inizializzare solo il bottone di insert
                this.initInsertOnly();
                return;
            }
        ...
        initInsertOnly: function () {

            this.insertFormButton = document.getElementById("insertButton");
            this.insertForm = {
                container: document.getElementById("JS_insertForm"),
                closeButton: document.getElementById("JS_insertFormCloseButton")
            };

            this.insertFormButton.addEventListener("click", this.show.bind(this, this.insertForm));
            this.insertForm.closeButton.addEventListener("click", this.close.bind(this, this.insertForm));
        },
